...
describe('Staking', () => {
  ...
  describe('stakeToken', () => {
    ...
    it('creates a position', async () => {
      const positionIds = await staking.connect(signer2).getPositionIdsByAddress()
      ...
      expect(position.wallet).to.equal(signer2.address)
  ...
  describe('calculateNumberDays', () => {
    it('returns the number of days since createdDate', async () => {
      ...
      const days = await staking.connect(owner).calculateNumberOfDays(oneYearAgo)
